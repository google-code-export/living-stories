...
public class QuoteContentItem extends BaseContentItem {
  ...
  public QuoteContentItem(Long id, Date timestamp, Set<Long> contributorIds, String content,
      Importance importance, Long livingStoryId) {
    super(id, timestamp, ContentItemType.QUOTE, contributorIds, content, importance, livingStoryId);
  }
