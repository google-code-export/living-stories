...
/**
 * Client-side version of an event atom
 */
public class EventAtom extends BaseAtom {
  ...
  public EventAtom(Long id, Date timestamp, Set<Long> contributorIds,
      Importance importance, Long livingStoryId, Date startDate, Date endDate,
      String update, String summary, String detailedContent) {
    super(id, timestamp, AtomType.EVENT, contributorIds, detailedContent, importance, 
        livingStoryId);
  ...
  public String getTypeString() {
    return Holder.msgs.contentTypeStringEvent();
  }
  ...
  public String getDisplayString() {
    return "[" + getAtomType().toString() + "] " + getEventUpdate();
  }
