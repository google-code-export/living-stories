...
/**
 * Create a popup that shows an atom relative to an element.
 */
public class AtomPopupWidget extends Composite {
  private static final String POPUP_WIDTH = "300px";
  
  private AutoHidePopupPanel popup;
  
  public AtomPopupWidget() {
    popup = new AutoHidePopupPanel();
    popup.setWidth(POPUP_WIDTH);
  }

  public void show(BaseAtom atom, Element showRelativeTo) {
    popup.setWidget(PopupViewFactory.createView(atom));
