...
public class ContainerStreamViewFooter extends Composite {
  ...
  public ContainerStreamViewFooter(BaseAtom atom) {
    atomId = atom.getId();
    importance = atom.getImportance();
  ...
  @UiFactory ShareLinkWidget makeShareLink() {
    return new ShareLinkWidget(atomId);
  }
    ...
    for (Map.Entry<String, Widget> e : typeStringToNavLinkTarget.entrySet()) {
      ...
      link.addClickHandler(new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
          ...
          EventBus.INSTANCE.fireEvent(new BlockToggledEvent(true, atomId)
