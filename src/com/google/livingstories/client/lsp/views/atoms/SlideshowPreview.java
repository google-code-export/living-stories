...
public class SlideshowPreview extends Composite {
  ...
  private AssetAtom atom;

  public SlideshowPreview(AssetAtom atom) {
    this.atom = atom;
  ...
  public void handleClick(ClickEvent e) {
    List<AssetAtom> allImages = atom.getRelatedAssets();
    new Slideshow(allImages).show(allImages.indexOf(atom));
  }
}
