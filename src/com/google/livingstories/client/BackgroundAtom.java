...
/**
 * Client-side version of a background atom
 */
public class BackgroundAtom extends BaseAtom {
  private String conceptName;
  
  public BackgroundAtom() {}
  
  public BackgroundAtom(Long id, Date timestamp, Set<Long> contributorIds, String content,
      Importance importance, Long livingStoryId, String conceptName) {
    super(id, timestamp, AtomType.BACKGROUND, contributorIds, content, importance, livingStoryId);
  ...
  public String getTypeString() {
    return isConcept() ? Holder.msgs.contentTypeStringConcept() : getAtomType().toString();
  }
